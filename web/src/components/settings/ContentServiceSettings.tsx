...
const CONTENT_SERVICE_DOCS_URL = 'https://github.com/lhc1119692022/Cnote/tree/main/workers'
    ...
    <section>
      ...
      <div className="rounded-xl border border-border bg-card p-5">
        ...
        <div className="mt-5 flex flex-wrap gap-2">
          ...
          <Button variant="secondary" size="sm" className="gap-1.5" onClick={() => window.open(CONTENT_SERVICE_DOCS_URL, '_blank', 'noopener,noreferrer')}><ExternalLink className="h-3.5 w-3.5" />部署说明</Button>
