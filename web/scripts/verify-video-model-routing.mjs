...
assert.equal(legacyFaceModel.videoRequestContract.referenceLimits.video, 0)
assert.equal(legacyFaceModel.videoRequestContract.videoReferencesField, undefined)
